...
const Product = () => {
  ...
  const { productId } = useParams();    // Tham so (parameter) productId theo duong dan Route trong App.jsx
    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border border-gray-300 px-6 py-6 text-sm text-gray-500'>
          <p>An e-commerce website is an online platform that facilitates the...</p>
          <p>An e-commerce website is an online platform that facilitates the...</p>
        </div>
      </div>
